...
class Spatial_Receptive_Fusion(BaseModule):
...
class Channel_Receptive_Interaction(BaseModule):
    def __init__(self, n_embd, n_layer, layer_id, shift_mode='q_shift',
...
class Block(BaseModule):
    def __init__(self, n_embd, n_layer, layer_id, shift_mode='q_shift',
        ...
        self.att = Spatial_Receptive_Fusion(n_embd, n_layer, layer_id, shift_mode,
                                   channel_gamma, shift_pixel, init_mode,
                                   key_norm=key_norm)

        self.ffn = Channel_Receptive_Interaction(n_embd, n_layer, layer_id, shift_mode,
